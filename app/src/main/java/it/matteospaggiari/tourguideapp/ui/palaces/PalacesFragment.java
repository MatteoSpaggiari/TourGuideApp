...
/**
 * {@link Fragment} that displays a list of Palaces.
 */
public class PalacesFragment extends Fragment {
    ...
    /* Variable for PalaceRecyclerAdapter object */
    private PalaceRecyclerAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(PalaceViewModel.class);
        ...
        // Specify an adapter
        mAdapter = new PalaceRecyclerAdapter(mViewModel);
