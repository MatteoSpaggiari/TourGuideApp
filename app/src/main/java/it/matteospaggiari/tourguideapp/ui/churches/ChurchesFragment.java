...
/**
 * {@link Fragment} that displays a list of Churches.
 */
public class ChurchesFragment extends Fragment {
    ...
    /* Variable for ChurchRecyclerAdapter object */
    private ChurchRecyclerAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(ChurchViewModel.class);
        ...
        // Specify an adapter
        mAdapter = new ChurchRecyclerAdapter(mViewModel);
