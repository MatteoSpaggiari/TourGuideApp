...
/**
 * {@link Fragment} that displays a list of Theaters.
 */
public class TheatersFragment extends Fragment {
    ...
    /* Variable for TheaterRecyclerAdapter object */
    private TheaterRecyclerAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(TheaterViewModel.class);
        ...
        // Specify an adapter
        mAdapter = new TheaterRecyclerAdapter(mViewModel);
