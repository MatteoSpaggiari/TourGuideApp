...
/**
 * {@link PalaceRecyclerAdapter} represent the RecyclerAdapter of the Palaces
 *
 **/
public class PalaceRecyclerAdapter extends RecyclerView.Adapter<PalaceRecyclerAdapter.ViewHolder> {

    /* Variable for ViewModel object */
    private PalaceViewModel mViewModel;

    public PalaceRecyclerAdapter(PalaceViewModel viewModel) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        viewHolder.mImage.setImageResource(mViewModel.getPalace(position).getImageResourceId());
        viewHolder.mName.setText(mViewModel.getPalace(position).getName());
    }

    /* Return the size of your dataset (invoked by the layout manager) */
    @Override
    public int getItemCount() {
        return mViewModel.numberPlaces();
    }
        ...
        ViewHolder(View itemView) {
            ...
            mPhone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setData(Uri.parse(mViewModel.getPalace(position).getPhone()));
            ...
            mWebsite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setData(Uri.parse(mViewModel.getPalace(position).getWebsite()));
                    v.getContext().startActivity(intent);
                }
            });
            ...
            mPosition.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    int position = getAdapterPosition();
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setData(Uri.parse(mViewModel.getPalace(position).getPosition()));
                    v.getContext().startActivity(intent);
                }
            });
        }
